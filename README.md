...
- ✨ Curious by nature — if it's a new tool, I'm probably already trying it
...
**[EmocionaU](https://plataforma-de-dialogo-foro.web.app)** — AI-Powered Emotional Support Platform

Web app for university students integrating ChatGPT API with Firebase for real-time, empathetic dialogue and secure role-based access.

`JavaScript` · `HTML/CSS` · `ChatGPT API` · `Firebase`
